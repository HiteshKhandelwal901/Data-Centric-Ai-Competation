...
print("train direcotry  = {} and valid direcotry  = {}"
      .format(user_data, valid_data))
...
if __name__ == "__main__":
    ...
    valid = tf.keras.preprocessing.image_dataset_from_directory(
        ...
        labels="inferred",
        label_mode="categorical",
        class_names=["i", "ii", "iii", "iv", "v", "vi", "vii", "viii", "ix",
                     "x"],
        shuffle=True,
        seed=123,
        batch_size=batch_size,
    ...
    total_length = ((train.cardinality() + valid.cardinality())
                    * batch_size).numpy()
